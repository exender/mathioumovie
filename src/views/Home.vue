<template>
  <div class="bg-gray-900">
    ...
    <div class="container mx-auto py-8">
      <button @click="$router.push('/allmovies')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
  Tous les films
</button>
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(
        `https://api.themoviedb.org/3/movie/popular?api_key=75e981bcdd819c45eea5057ee60c7c36&language=fr-FR&page=1`
      )
      .then((response) => {
